...
from hummingbot.strategy.trinity.data_types import PriceSize, Proposal
from hummingbot.strategy.trinity.trinity_order_tracker import (
    TrinityOrderTracker,
)
...
class TrinityStrategy(StrategyPyBase):
    ...
    def init_params(self,
        ...
        self._sb_order_tracker = TrinityOrderTracker()
