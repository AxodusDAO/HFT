...
from hummingbot.indicators.moving_average import MACalc, MAType
...
class MACross:
    ...
    def __post_init__(self):
        self.ma_type = MAType(self.ma_type, self.prices, self.timestamp)
    ...
    def get_ma(self):
        if self.ma_type.ma_type == "sma":
            return MACalc.get_sma(self.prices, self.timestamp)
        elif self.ma_type.ma_type == "ema":
